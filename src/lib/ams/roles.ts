...
export type RoleSlug =
  ...
  | "manager" | "administrator" | "founder" | "operator";
...
export const ROLES: RoleDNA[] = [
  ...
  },
  {
    ...
    behavior: ["Orchestrator", "Coach", "Planner", "Decision Maker"],
    accent: "#60a5fa",
    glyph: "◑",
    passportPrefix: "SV-MGR",
    motto: "Clarity, cadence, results.",
    vision: "A team that ships predictably and grows continuously.",
    mission: "Remove blockers, set direction, multiply the team's output.",
    philosophy: "A manager's output is the team's output.",
    signature: "Signed with a planning review.",
    greeting: "Welcome back, leader.",
    welcome: "Your board is ready. Let's align the week.",
    congratulations: "Sprint delivered — the team's cadence is holding.",
    celebration: "Quarter closed above target — leadership recognized.",
    motivation: "Every unblocked teammate is a compounding win.",
    language: ["Sprint", "Cadence", "OKR", "Roadmap", "Review", "Capacity", "Velocity", "1:1", "Escalation", "Forecast"],
    successDefinition: "Predictable delivery, growing people, healthy team metrics.",
    careerPath: ["Team Lead", "Manager", "Senior Manager", "Director", "VP", "Chief of Staff", "Founding Leader"],
    legacyLine: "The teams you built still run on the cadence you set.",
    awardStyle: "Leadership Awards",
    awardExamples: ["First Sprint Delivered", "Team Builder", "OKR Champion", "Zero-Slip Quarter", "People Multiplier", "Leadership Legend"],
    trophyStyle: "Compass Trophies",
    trophies: tiers(["Bronze Compass", "Silver Helm", "Gold Command", "Diamond Directive", "Elite Leader", "Legendary Leader", "Founding Leader"]),
    badges: badges(["Verified Manager", "High-Performing Team", "First 100 Reviews", "Trusted Leader", "Elite Leader", "Legendary Leader", "Founding Leader"]),
    certificates: certs(["Leadership Certificate", "Professional Manager", "Expert Manager", "Master Leader", "Elite Leader", "Legendary Leader", "Founding Leader"]),
    passport: {
      cover: "Steel-blue brushed metal with silver compass rose over midnight.",
      stamp: "Compass seal stamp with review hash.",
      verification: "Leadership Verified",
      timeline: ["First Team", "First Quarter Delivered", "First Promotion Led", "Leadership Chapter"],
    },
    journey: journey([
      "Leading your first small team.",
      "Establishing cadence and rituals.",
      "Owning delivery for a full team.",
      "Coaching leads and shaping strategy.",
      "Running multi-team programs.",
      "Named among the platform's legendary leaders.",
      "Inducted into the Leadership Hall of Fame.",
      "Your operating model still guides the org.",
    ]),
    reputationPillars: ["Delivery", "People Growth", "Clarity", "Accountability", "Forecast Accuracy", "Consistency", "Mentorship"],
    collections: ["Cadence Stamps", "Compass Trophies", "Leadership Certificates", "Command Badges", "Quarter Ribbons", "Directive Seals"],
  },
  {
    slug: "administrator",
    name: "Administrator",
    archetype: "Guardian of Systems",
    behavior: ["Guardian", "Auditor", "Policy Keeper", "Operator"],
    accent: "#a78bfa",
    glyph: "⌗",
    passportPrefix: "SV-ADM",
    motto: "Control with accountability.",
    vision: "A platform where every action is governed and traceable.",
    mission: "Protect integrity, enforce policy, keep the system trustworthy.",
    philosophy: "Power is only safe when it is audited.",
    signature: "Signed with an audit entry.",
    greeting: "Welcome back, administrator.",
    welcome: "Control plane online. Governance is live.",
    congratulations: "Policy enforced — the ledger stays clean.",
    celebration: "Zero-incident cycle closed — governance holding strong.",
    motivation: "Every audited action makes the platform safer for everyone.",
    language: ["Policy", "Audit", "Role", "Permission", "Governance", "Incident", "Ledger", "Override", "Compliance", "Integrity"],
    successDefinition: "Airtight governance, clean audits, zero unauthorized actions.",
    careerPath: ["Operator", "Administrator", "Senior Administrator", "Platform Admin", "Head of Governance", "Chief Trust Officer", "Founding Administrator"],
    legacyLine: "The guardrails you wrote still protect the platform.",
    awardStyle: "Governance Awards",
    awardExamples: ["First Policy Shipped", "Clean Audit Cycle", "Zero-Incident Month", "Permission Architect", "Compliance Champion", "Governance Legend"],
    trophyStyle: "Keystone Trophies",
    trophies: tiers(["Bronze Keystone", "Silver Sentinel", "Gold Warden", "Diamond Arbiter", "Elite Guardian", "Legendary Guardian", "Founding Administrator"]),
    badges: badges(["Verified Administrator", "Clean-Audit Operator", "First 100 Policies", "Trusted Guardian", "Elite Guardian", "Legendary Guardian", "Founding Administrator"]),
    certificates: certs(["Operator Certificate", "Professional Administrator", "Expert Administrator", "Master Guardian", "Elite Guardian", "Legendary Guardian", "Founding Administrator"]),
    passport: {
      cover: "Deep violet with platinum keystone crest and micro-engraved policy lattice.",
      stamp: "Keystone seal stamp with audit hash.",
      verification: "Governance Verified",
      timeline: ["First Policy", "First Clean Audit", "First Zero-Incident Cycle", "Governance Chapter"],
    },
    journey: journey([
      "Learning the control plane.",
      "Managing roles and permissions.",
      "Owning policy for a full domain.",
      "Leading audits and incident reviews.",
      "Setting governance strategy platform-wide.",
      "Named among the platform's legendary guardians.",
      "Inducted into the Governance Hall of Fame.",
      "Your guardrails still hold the platform together.",
    ]),
    reputationPillars: ["Integrity", "Audit Quality", "Response Time", "Policy Clarity", "Least Privilege", "Consistency", "Trust"],
    collections: ["Audit Stamps", "Keystone Trophies", "Governance Certificates", "Warden Badges", "Policy Ribbons", "Integrity Seals"],
  },
  {
    slug: "founder",
    name: "Founder",
    archetype: "Origin",
    behavior: ["Visionary", "Builder", "Risk Taker", "Steward"],
    accent: "#e8c15c",
    glyph: "✦",
    passportPrefix: "SV-FDR",
    motto: "Build what should exist.",
    vision: "An institution that outlives its founders.",
    mission: "Turn conviction into a durable, compounding platform.",
    philosophy: "Vision without execution is decoration.",
    signature: "Signed by the founding hand.",
    greeting: "Welcome back, founder.",
    welcome: "The origin ledger is open. Let's build the next chapter.",
    congratulations: "Milestone founded — it's now part of the origin story.",
    celebration: "Legacy chapter sealed — the founding mark is permanent.",
    motivation: "Everything standing today started as your unreasonable idea.",
    language: ["Vision", "Origin", "Charter", "Equity", "Legacy", "Conviction", "Institution", "Mandate", "Chapter", "Steward"],
    successDefinition: "A self-sustaining institution, a durable culture, a permanent legacy.",
    careerPath: ["Idea", "Builder", "Founder", "Scaling Founder", "Institution Builder", "Steward", "Legacy Founder"],
    legacyLine: "Your name is engraved in the platform's origin plate.",
    awardStyle: "Founding Awards",
    awardExamples: ["Origin Charter", "First Hundred Members", "First Institution Milestone", "Culture Architect", "Legacy Builder", "Founding Legend"],
    trophyStyle: "Origin Trophies",
    trophies: tiers(["Bronze Origin", "Silver Charter", "Gold Foundation", "Diamond Institution", "Elite Founder", "Legendary Founder", "Founding Legend"]),
    badges: badges(["Verified Founder", "Origin Signatory", "First Hundred", "Trusted Steward", "Elite Founder", "Legendary Founder", "Founding Legend"]),
    certificates: certs(["Charter Certificate", "Professional Founder", "Expert Founder", "Master Steward", "Elite Founder", "Legendary Founder", "Founding Legend"]),
    passport: {
      cover: "Obsidian black with 24k gold origin crest, guilloche engraving and wax-seal emboss.",
      stamp: "Origin wax seal with founding date engraving.",
      verification: "Founding Verified",
      timeline: ["Origin Charter", "First Hundred", "First Institution Milestone", "Legacy Chapter"],
    },
    journey: journey([
      "Writing the first charter.",
      "Assembling the founding circle.",
      "Building the first durable systems.",
      "Scaling the institution.",
      "Stewarding culture at scale.",
      "Named among the platform's legendary founders.",
      "Inducted into the Founders Hall of Fame.",
      "The institution still carries your founding mark.",
    ]),
    reputationPillars: ["Vision", "Conviction", "Stewardship", "Culture", "Durability", "Integrity", "Legacy"],
    collections: ["Origin Stamps", "Founding Trophies", "Charter Certificates", "Founder Seals", "Legacy Ribbons", "Institution Plates"],
  },
  {
    slug: "operator",
    name: "Operator",
    archetype: "Controller",
    behavior: ["Executor", "Monitor", "Responder", "Optimizer"],
    accent: "#34d399",
    glyph: "◎",
    passportPrefix: "SV-OPR",
    motto: "Keep the system running.",
    vision: "An operation that never drops a beat.",
    mission: "Run daily operations with precision, uptime and zero surprises.",
    philosophy: "Calm hands beat heroic saves.",
    signature: "Signed from the control desk.",
    greeting: "Welcome back, operator.",
    welcome: "Control desk is live. All systems under your watch.",
    congratulations: "Clean run logged — operations stayed green.",
    celebration: "Zero-incident cycle closed — the board is all green.",
    motivation: "Every quiet shift is proof your systems were built right.",
    language: ["Runbook", "Shift", "Queue", "Uptime", "Incident", "Throughput", "SLA", "Escalation", "Dispatch", "Control"],
    successDefinition: "Consistent uptime, cleared queues, and incidents resolved before they escalate.",
    careerPath: ["Trainee Operator", "Operator", "Senior Operator", "Shift Lead", "Operations Expert", "Control Chief", "Legacy Operator"],
    legacyLine: "Your runbooks still keep the operation steady.",
    awardStyle: "Operations Awards",
    awardExamples: ["Zero-Incident Shift", "Queue Clearer", "Uptime Guardian", "Runbook Architect", "Escalation Ace", "Operations Legend"],
    trophyStyle: "Control Trophies",
    trophies: tiers(["Bronze Console", "Silver Console", "Gold Console", "Diamond Control", "Elite Operator", "Legendary Operator", "Founding Operator"]),
    badges: badges(["Verified Operator", "Uptime Keeper", "Shift Milestone", "Runbook Expert", "Elite Operator", "Legendary Operator", "Founding Operator"]),
    certificates: certs(["Operations Participation", "Professional Operator", "Expert Operator", "Master Controller", "Elite Operator", "Legendary Operator", "Founding Operator"]),
    passport: {
      cover: "Graphite steel with emerald control-dial inlays and precision-milled gauge rings.",
      stamp: "Control-dial stamp with shift seal engraving.",
      verification: "Operations Verified",
      timeline: ["First Shift", "First Clean Cycle", "Incident Command", "Control Legacy"],
    },
    journey: journey([
      "Learning the runbooks.",
      "Holding your first solo shifts.",
      "Running the desk with confidence.",
      "Owning escalations end to end.",
      "Setting the operational standard.",
      "Named among the platform's legendary operators.",
      "Inducted into the Operations Hall of Fame.",
      "Your control standards are still the default.",
    ]),
    reputationPillars: ["Reliability", "Vigilance", "Precision", "Response", "Consistency", "Calm", "Ownership"],
    collections: ["Shift Stamps", "Control Trophies", "Operations Certificates", "Uptime Seals", "Console Plates", "Incident Ribbons"],
  },
];
