...
export const rolePolicies: Record<AppRole, RolePolicy> = {
  ...
  manager: {
    ...
    deny: ["super-admin", "admin", "accountant", "account-manager", "roles", "role-simulator", "role-compare", "permission-audit", "threats", "api-manager"],
  },
  accountant: {
    groups: [
    ...
    deny: ["super-admin", "admin", "manager", "account-manager", "roles", "role-simulator", "role-compare", "permission-audit", "hrm", "recruitment", "threats", "sessions", "devices", "api-manager"],
  },
  account_manager: {
    groups: [
    ...
    deny: ["super-admin", "admin", "manager", "accountant", "roles", "role-simulator", "role-compare", "permission-audit", "hrm", "recruitment", "threats", "sessions", "devices", "api-manager", "audit", "trail"],
  },
  user: {
    ...
    deny: ["super-admin", "admin", "manager", "accountant", "account-manager", "roles", "role-simulator", "role-compare", "permission-audit", "audit", "trail", "threats", "sessions", "devices", "api-manager"],
  },
};
